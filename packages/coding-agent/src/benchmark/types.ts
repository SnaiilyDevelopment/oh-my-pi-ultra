import type { AgentRunCoverage, AgentRunSummary } from "@oh-my-pi/pi-agent-core";

export const BENCHMARK_VERSION = 1 as const;
export const BENCHMARK_CATEGORIES = [
	"simple", "medium", "hard", "debugging", "refactoring", "architecture", "large-repo", "frontend", "backend", "full-stack",
] as const;
export type BenchmarkCategory = (typeof BENCHMARK_CATEGORIES)[number];
export const BENCHMARK_VARIANTS = ["baseline", "ultra"] as const;
export type BenchmarkVariant = (typeof BENCHMARK_VARIANTS)[number];
export const OUTCOMES = ["SUCCESS", "PARTIAL_SUCCESS", "FAILED", "BLOCKED", "TIMEOUT", "CRASHED", "UNVERIFIED"] as const;
